var shareWords = '带您体验名爵锐腾的优秀性能';
//下方注释部分为动态改变时使用
// var myScore=localStorage.getItem("score");
// if(!myScore){shareWords="给欧文留言的，快来约个下午茶吧！";}
// else{shareWords="我是第"+myScore+"个给欧文留言的，快来约个下午茶吧！";}
//分享JS
var siteUrl='http://mgm.dzing.com.cn/xianxia/';
var ShareUrl = 'http://mgm.dzing.com.cn/xianxia/index.html';
//var ShareUrl = 'http://gm.dzing.com.cn/qingmingwap/d46/index.html';
var wxContent={
    timeLink: ShareUrl,
    friendLink: ShareUrl,
    ...
    title: '名爵锐腾试驾指南',
    friend: shareWords,  //发送朋友描述
    timeline: '名爵锐腾试驾指南'  //发送朋友圈描述
};
//微信检测
